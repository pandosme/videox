...
A comprehensive local network recording engine for Axis IP cameras with continuous recording, live streaming, and intelligent retention management.

## Overview

VideoX is a self-hosted designed for home and small business networks. It provides professional-grade video surveillance capabilities using Axis IP cameras with an intuitive web interface.
